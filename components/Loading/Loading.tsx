...
const Loading = () => {
  return (
    <div
      role="status"
      className="space-y-8 mb-5 animate-pulse md:space-y-0 md:space-x-8 md:flex md:items-center"
    >
      ...
      <div className="flex flex-col gap-5 w-full">
        ...
        <div className="w-full gap-1 px-3 flex">
          <div className="h-10 w-20 bg-gray-200 rounded-full dark:bg-gray-700 "></div>
          <div className="h-10 w-20 bg-gray-200 rounded-full dark:bg-gray-700 "></div>
          <div className="h-10 w-20 bg-gray-200 rounded-full dark:bg-gray-700 "></div>
        </div>
      </div>
